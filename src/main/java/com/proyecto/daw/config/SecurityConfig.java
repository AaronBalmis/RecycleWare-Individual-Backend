    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/moderation/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/moderation/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/moderation/**").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/comunidad/resenas", "/donaciones/ranking", "/donaciones/ultima", "/solicitudes/entregadas/count", "/estadisticas/impacto-global").permitAll()
